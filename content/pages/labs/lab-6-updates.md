...
More information on the uSimMarine simulator and configuration options can be found in the {{% resource_link "c54745d4-f8ae-4408-b2b1-14e1846fae3f" "moos-ivp autonomy utilities documentation (PDF - 29.2MB)" %}}.
...
More information on the uSimMarine simulator and configuration options can be found in the utilities {{% resource_link "c54745d4-f8ae-4408-b2b1-14e1846fae3f" "moos-ivp autonomy documentation (PDF - 29.2MB)" %}}.
...
More information on configuring the IvPHelm decision domain may be found on p. 47 in the {{% resource_link "c54745d4-f8ae-4408-b2b1-14e1846fae3f" "helm documentation (PDF - 29.2MB)" %}}.
