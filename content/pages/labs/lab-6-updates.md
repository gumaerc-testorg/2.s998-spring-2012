...
More information on the uSimMarine simulator and configuration options can be found in the {{% resource_link "eb1248ef-17a1-47a6-974a-21c5fa8b82aa" "moos-ivp autonomy utilities documentation (PDF - 29.2MB)" %}}.
...
More information on the uSimMarine simulator and configuration options can be found in the utilities {{% resource_link "eb1248ef-17a1-47a6-974a-21c5fa8b82aa" "moos-ivp autonomy documentation (PDF - 29.2MB)" %}}.
...
More information on configuring the IvPHelm decision domain may be found on p. 47 in the {{% resource_link "eb1248ef-17a1-47a6-974a-21c5fa8b82aa" "helm documentation (PDF - 29.2MB)" %}}.
